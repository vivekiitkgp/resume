...
\begin{resume_section}{Skills}
  ...
  \textbf{General Information} \= Git, Test Driven Development, Scientific Computing, Software Practices (YAGNI etc.,)\\*
...
\begin{resume_section}  {Open Source Projects \footnotesize {\url{https://github.com/vivekiitkgp/}}}
  \begin{resume_subsection}[\footnotesize {\url{https://github.com/yannickwurm/sequenceserver}}]{SequenceServer}
    \begin{subitems}
...
\begin{resume_subsection}[T/L indicates Theory and Laboratory classes]{Departmental Courses}
    \begin{subitems}
        \begin{multicols}{2}
    ...
    \end{subitems}
\end{resume_subsection}
\begin{resume_subsection}[\#To be completed by Spring 2015]{Other Courses}
    \begin{subitems}
        \begin{multicols}{2}
